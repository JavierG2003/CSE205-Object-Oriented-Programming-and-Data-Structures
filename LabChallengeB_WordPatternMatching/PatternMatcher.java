 ...
 */
 ...
 public class PatternMatcher {
     ...
     public static void main(String[] args) throws FileNotFoundException {
         ArrayList<String> words = getWordList("words2.txt");
         System.out.println(getMatches(words, "a___e"));
     }
      */
     ...
     public static boolean isMatchAtIndex(String word, String pattern, int index) {
         ...
         if (index >= word.length() || index >= pattern.length())
             return false;
         // if the char at index in pattern is an unerscore, then it is always a match
